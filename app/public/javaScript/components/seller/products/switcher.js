 ...
 */
    ...
    const containerGames = this.createRadioContainer('select-header-products-seller-1', 'sellProducts', 'Продажа', 'select-header-1', true);
    const containerChapters = this.createRadioContainer('select-header-orders-seller-2', 'buyProducts', 'Покупка', 'select-header-1');
